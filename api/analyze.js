...
장수 카드에 표시된 빨간색 숫자는 승급 숫자다.

예를 들어 카드에

"50 조조"

그리고 카드 위쪽이나 카드에 빨간색 숫자가 표시되어 있다면,
50은 레벨이고 빨간색 숫자는 승급이다.
...
장수는 화면에 보이는 순서대로 기록한다.

화면에서 확실하게 읽을 수 없는 문자열은 ""로 한다.

화면에서 확실하게 읽을 수 없는 숫자는 0으로 한다.
